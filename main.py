...
itemDescriptions = {'bookshelves':"nothing to see here.", 'box':"looks like you need a key to get into this box.", 'pots':'you found a tiny key!', 'planters':'there\'s something to find in this room, keep looking!', 'couch':'nothing to see here.', 'tv':'The old TV flickers on. It asks you for a five digit code.', 'lightbulb':'nothing to see here.', 'door':"You hear the sound of birds chirping outside. This must be the way out! The door is locked and requires a key", 'corn':'nothing to see here.', 'bed': 'nothing to see here.', 'desk':'nothing to see here.', 'stove':'nothing to see here.', 'cabinets':'nothing to see here.',  'cookies':'You found some chocolate chip cookies! yum. You notice a key under them!', 'mirrors':'nothing to see here.'}
